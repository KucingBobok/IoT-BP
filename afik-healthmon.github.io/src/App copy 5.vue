...
<template>
  ...
  <aside>
    <card-status :raw-data="RawData" @update="updateCardStatus"></card-status>
  </aside>
  <body></body>
  <article>
    <div id="app" class="container-fluid">
      <div class="row">
        <div class="col-sm-6" v-if="arrSystolic.length > 0">
          <h2>Map</h2>
          <line-chart
            :chartData="arrMap"
        ...
        <div class="col-sm-6" v-if="arrDiastolic.length > 0">
          <h2>Diastolic</h2>
          <line-chart
        ...
        <div class="col-sm-6" v-if="arrHr.length > 0">
          <h2>Heart Rate</h2>
          <line-chart
            :chartData="arrHr"
            :options="chartOptions"
